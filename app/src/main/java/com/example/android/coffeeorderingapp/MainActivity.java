...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT,
                getString(R.string.order_summary_name));
    ...
    private String createOrderSummary(String name, int price, boolean addWhippedCream,
        ...
        String priceMessage = getString(R.string.coffee_ordering_app);
        priceMessage += "\n" + getString(R.string.coffee_ordering_app_cream);
        priceMessage += "\n" + getString(R.string.coffee_ordering_app_prices);
        priceMessage += "\n" + getString(R.string.coffee_ordering_app_quantity);
        priceMessage += "\n" + getString(R.string.coffee_ordering_app_prices);
